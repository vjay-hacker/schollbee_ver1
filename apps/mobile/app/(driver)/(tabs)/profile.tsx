...
export default function DriverProfileTab() {
  ...
  return (
    <View className="flex-1 bg-[#0F0F23] px-4 pt-12 items-center justify-center">
      <View className="w-24 h-24 bg-[#FD79A8] rounded-full justify-center items-center mb-4">
        <User color="#FFFFFF" size={48} />
      </View>
      <Text className="text-white text-xl font-bold">Michael Vance</Text>
      <Text className="text-gray-400 text-xs mt-1 mb-8">michael.vance@schoolbee.com</Text>
